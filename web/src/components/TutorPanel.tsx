    ...
    <div ref={panelRef}>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-all hover:scale-105 ${
          open
            ? "bg-gray-800 shadow-black/30 rotate-45"
      ...
      >
        {open ? (
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-300 -rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed z-50 bottom-24 right-6 w-[calc(100vw-3rem)] sm:w-96 max-h-[60vh] bg-gray-900 rounded-2xl shadow-2xl shadow-black/50 border border-gray-700 flex flex-col">
          {/* Header */}
