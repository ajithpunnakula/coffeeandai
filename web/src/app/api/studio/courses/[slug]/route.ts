...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/studio/courses/[slug] error:", err);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/studio/courses/[slug] error:", err);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 },
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/studio/courses/[slug] error:", err);
    return NextResponse.json(
      { error: "Internal server error" },
      { status: 500 },
    );
